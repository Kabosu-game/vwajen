...
<?php endif; ?>
    ...
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(! $isSimple): ?>
        ...
        >
            <?php
                $overviewCounts = [
                    'first' => (string) ($paginator->firstItem() ?? 0),
                    'last' => (string) ($paginator->lastItem() ?? 0),
                    'total' => (string) $paginator->total(),
                ];
            ?>
            <?php echo e(trans_choice('filament::components/pagination.overview', $paginator->total(), $overviewCounts)); ?>
...
<?php /**PATH /opt/lampp/htdocs/all/vwajen_app/vwajen_api/resources/views/vendor/filament/components/pagination/index.blade.php ENDPATH**/ ?>